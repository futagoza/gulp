...
/**
 * An object type that can be handled by pump or streams.pipeline
 */
type PumpStream = NodeJS.ReadableStream | NodeJS.WritableStream;

/**
 * An object type that can be handled by @futagoza/pump
 */
type PumpEntry = pump.PumpStream | Promise<any> | Function;
 ...
 */
declare function pump( streams: PumpStream[], callback ?: PumpCallback ): PumpStream[];
 ...
 * @param streams An array of Node streams.
 */
declare function pump( ...streams: Array<PumpStream | PumpCallback> ): PumpStream[];
 ...
 */
declare function p( ...args: PumpEntry[] ): Promise<any>;
 ...
 */
declare function p( entry: PumpEntry ): Promise<any>;
